...
MapsAutocompleteResponse mapsAutocompleteResponseFromJson(String str) => MapsAutocompleteResponse.fromJson(json.decode(str));

String mapsAutocompleteResponseToJson(MapsAutocompleteResponse data) => json.encode(data.toJson());

class MapsAutocompleteResponse {
    MapsAutocompleteResponse({
    ...
    factory MapsAutocompleteResponse.fromJson(Map<String, dynamic> json) => MapsAutocompleteResponse(
...
class Prediction {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "terms": List<Term>.from(terms.map((x) => x.toJson())),
        "types": (types ==null) ? [] : List<String>.from(types!.map((x) => x)),
    };
}
